...
{
    public class ExecutePagePluginHost : PluginHost
    {
        //we want to have the plugin in both the collection of ExecutePagePluginHost, as well as in global PluginHost.Collection, so everything is overriden
