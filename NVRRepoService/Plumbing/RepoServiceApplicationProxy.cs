//-----------------------------------------------------------------------
// <copyright file="RepoServiceApplicationProxy.cs" company="">
// Copyright © 
// </copyright>
//-----------------------------------------------------------------------
...
namespace Navertica.SharePoint.RepoService.Service
{
    ...
    /// </summary>
    [System.Runtime.InteropServices.Guid("ff7079d8-441b-4fce-9256-75b933c98509")]
    [IisWebServiceApplicationProxyBackupBehavior]
    [SupportedServiceApplication("405e70c4-1eb3-4524-9711-27270e574813", "1.0.0.0", typeof(RepoServiceProxy))]
    internal sealed class RepoServiceApplicationProxy : SPIisWebServiceApplicationProxy
    {
        #region Fields
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RepoServiceApplicationProxy"/> class. Default constructor (required for SPPersistedObject serialization). Never call this directly.
        /// </summary>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public RepoServiceApplicationProxy()
        {
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="RepoServiceApplicationProxy"/> class. Use this constructor to create a new Service Application Proxy (e.g. from code on the Create page).
        /// </summary>
        ...
        internal RepoServiceApplicationProxy(string name, RepoServiceProxy serviceProxy, Uri serviceEndpointUri)
        ...
        public override string TypeName
        {
            get
            {
                return SPUtility.GetLocalizedString("$Resources:ServiceApplicationProxyName", "NVRRepoService.ServiceResources", (uint)System.Threading.Thread.CurrentThread.CurrentCulture.LCID);
            }
        }
        ...
        {
            get { return this.OpenClientConfiguration(SPUtility.GetVersionedGenericSetupPath(@"WebClients\NVRRepoService", 15)); }
        }
