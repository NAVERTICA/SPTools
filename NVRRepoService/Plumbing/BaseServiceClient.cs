...
namespace Navertica.SharePoint.RepoService.Service
{
    ...
    public abstract class BaseServiceClient
    {
        ...
        /// </summary>
        private RepoServiceApplicationProxy currentProxy;
        ...
        /// </summary>
        protected BaseServiceClient() : this(null) {}
        ...
        /// </summary>
        internal RepoServiceApplicationProxy Proxy
        {
            get
            {
                if (this.currentProxy == null)
                {
                    this.currentProxy = (RepoServiceApplicationProxy)this.currentServiceContext.GetDefaultProxy(typeof(RepoServiceApplicationProxy));
                }
