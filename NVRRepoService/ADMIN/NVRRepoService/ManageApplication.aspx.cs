...
namespace Navertica.SharePoint.RepoService.Service.Administration
{
    ...
    public partial class ManageApplicationPage : BaseAdminPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                SPUtility.TransferToErrorPage(HttpContext.GetGlobalResourceObject("NVRRepoService.ServiceAdminResources", "ErrorNoServiceApplication", CultureInfo.CurrentCulture).ToString());
            }
