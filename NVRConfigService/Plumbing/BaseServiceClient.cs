...
namespace Navertica.SharePoint.ConfigService.Service
{
    ...
    public abstract class BaseServiceClient
    {
        ...
        /// </summary>
        private ConfigServiceApplicationProxy currentProxy;
        ...
        /// </summary>
        internal ConfigServiceApplicationProxy Proxy
        {
            get
            {
                if (this.currentProxy == null)
                {
                    this.currentProxy = (ConfigServiceApplicationProxy)this.currentServiceContext.GetDefaultProxy(typeof(ConfigServiceApplicationProxy));
                }
